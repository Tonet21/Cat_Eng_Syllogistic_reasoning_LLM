...
for premise1, premise2, mood in syllogisms:
    ...
    between three backticks. Your answer should only be one of the answers or <NVC> if 
    you don't find a valid conclusion. The choices and the conclusions will be presented
